...
public class MenuExampleView extends JFrame {
	...
	public MenuExampleView() {
		...
		// TAO MỘT JM ITEM VIEW MỚI ĐỂ TẠO TICK, JCHECK BOX
		
		JMenu jm_3 = new JMenu("View");
		JCheckBoxMenuItem jbmi = new JCheckBoxMenuItem("Toolbar");
		jm_3.add(jbmi);
		jbmi.addActionListener(mec);
	...
	public void antoolbar() {
		
			this.remove(jtb);this.resetgiaodien();
	
		
		
	}
	public void resetgiaodien() {
