...
public class TimKiemView extends JFrame{
	...
	private void init() {
		...
		// tạo thanh cuộn JScrollPane
		JScrollPane jsp = new JScrollPane(jta_vanban); // luôn hiện
		//JScrollPane jsp = new JScrollPane(jta_vanban, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED); // luôn hiện
