...
public class LOGIN extends JFrame {
	...
	public LOGIN() {
		...
		lblNewLabel_4.setIcon(new ImageIcon("D:\\BAI_TAP_JAVA\\QLLK_NEW\\src\\img\\160317icon_login.png"));
		...
		lblNewLabel_2.setBounds(149, 63, 116, 36);
		...
		btnNewButton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        if (textField.getText().equals("") || passwordField.getPassword().length == 0) {
		            ...
		            LoginDao loginDao = new LoginDao();
		            if (loginDao.dieuKienLogin(username, password)) {
