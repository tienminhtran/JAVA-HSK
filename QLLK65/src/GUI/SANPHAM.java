...
public class SANPHAM extends JPanel implements MouseListener {
	...
	public SANPHAM() {
		...
		comboBox_thhieu.setModel(new DefaultComboBoxModel(
				new String[] { "Dell", "Asus", "Intel", "SamSum", "Iphone", "ViewSonic", "MSI", "ASUS" }));
...
//		refreshData();
    ...
    private Object[][] convertDataToVector(List<SanPham> data) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            result[i] = new Object[]{sp.getMaLK(), sp.getTenLK(), sp.getDonGia(), sp.getSoLuongTon(),sp.getMoTaLK(),sp.getNgayNhap(), sp.getThuongHieu(),sp.getBaoHanh()};
        }
        return result;
    }
