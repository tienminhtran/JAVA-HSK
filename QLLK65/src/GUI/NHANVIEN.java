...
//	}
	...
	public Object[] getColumnNames() {
		// TODO Auto-generated method stub
        return new Object[]{"Mã NV","Tên NV","Password","Giới tính", "Chức vụ", "SĐT", "Địa chỉ"};
	...
	public Object[][] convertDataToVector(List<NhanVien> newData) {
		...
		for (int i = 0; i < newData.size(); i++) {
			...
			result[i] = new Object[] {nv.getMaNV(),nv.getHoTen(), nv.getMK(), nv.getGioiTinh(), nv.getChucVu(), nv.getSdt(), nv.getDiachi()};
