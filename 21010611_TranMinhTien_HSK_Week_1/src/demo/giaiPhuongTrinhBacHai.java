...
public class giaiPhuongTrinhBacHai extends JFrame implements ActionListener{
	...
	public giaiPhuongTrinhBacHai() throws HeadlessException {
...
//			JLabel jta_rong8= new JLabel();
	...
	public void giaiPhuongTrinh() {
		Double s1 = Double.valueOf(this.jtf_a.getText());
		Double s2 = Double.valueOf(this.jtf_b.getText());
		Double s3 = Double.valueOf(this.jtf_c.getText());
