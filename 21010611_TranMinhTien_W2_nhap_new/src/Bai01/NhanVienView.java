		...
		jp_center.setLayout(null);
			...
			JSplitPane jspane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT);
				...
				JPanel jp_bot_trai = new JPanel();
					...
					JTextField jtf_khungtim = new JTextField(10);
				...
				JPanel jp_bot_phai = new JPanel();
					...
					jb_capnhat = new JButton("Cập nhật");
					jb_capnhat.addActionListener(this);
					
					jb_thoat = new JButton("Thoát");
					jb_thoat.addActionListener(this);
					
					jp_bot_phai.add(jb_them);
					jp_bot_phai.add(jb_capnhat);
	...
	public void themnv() throws Exception{
		...
		if(qlnvModel.insert(nv)) {
			Object[] obj = new Object[6];
 			obj[0]=	Integer.toString(maNv);
			obj[1]=	ho;
			obj[2]=	ten;
			obj[3]=	(nv.getPhai()?"Nam":"Nữ");
			obj[4]=	Integer.toString(tuoi);
			obj[5]=	Double.toString(tienluong);
				
			int a = JOptionPane.showConfirmDialog(this, "Thêm thành công nhân viên");
