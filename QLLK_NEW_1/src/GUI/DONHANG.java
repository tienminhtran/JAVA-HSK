...
public class DONHANG extends JPanel {
	...
	public DONHANG() {
		...
		btnNewButton_1.setBounds(319, 503, 125, 42);
		...
		btnNewButton_1_1.setBackground(new Color(219, 189, 70));
		btnNewButton_1_1.setBounds(491, 503, 125, 42);
		...
		btnNewButton_1_1_1.setBounds(663, 503, 125, 42);
